    ...
    <NavigationContainer>
      ...
      <Stack.Navigator
        ...
        screenOptions={{
          ...
          headerTintColor: Colors.primary, // Set the header tint color to the new primary color
      ...
      >
        ...
        />
        {/* Filter screen for guests */}
        <Stack.Screen 
          name="Filter" 
          component={FilterScreen}
          options={{
            title: 'Filter Menu', // Set the title of the screen
          }}
        />
      </Stack.Navigator>
    </NavigationContainer>
...
const styles = StyleSheet.create({
  header: {
    ...
    shadowColor: '#000', // Add subtle shadow for elevation
  ...
  headerTitle: {
    ...Typography.header,
    color: Colors.primary, // Use primary color for header title
  },
});